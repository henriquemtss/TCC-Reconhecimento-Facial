        ...
        <main class="container">
            ...
            <img style="width: 50%;" id='logoHolder' src="../assets/imagens/logo.png" alt="Logo Sistema Face ID" class="">
                ...
                <form target="POST" method="save_photos.php">
                    ...
                    <button style="display: none;" class="reconhecimento-facial__button buttonCamera" type="button" id="save" onclick="saveSnapShot(save, A)"> salvar</button>
            ...
            <canvas id='canvas2' style="display: none;"></canvas>
                ...
                <form target="POST" method="save_photos.php">
                    ...
                    <button style="display: none;" class="reconhecimento-facial__button buttonCamera" type="button" id="save2" onclick="saveSnapShot(save2, A)"> salvar</button>
            ...
            <canvas id='canvas3' style="display: none;"></canvas>
                ...
                <form target="POST" method="save_photos.php">
                    ...
                    <button style="display: none;" class="reconhecimento-facial__button buttonCamera" type="button" id="save3" onclick="saveSnapShot(save3, A)"> salvar</button>
                    <button style="display: none;" class="reconhecimento-facial__button buttonCamera" type="button" id="again3" onclick="retakeSnapShot(again3)"> Cancelar</button>
                </form>
			<!--Scripts-->
